...
module m_likelihood
    ...
    public :: likelihood, noise_likelihood
    public :: update_lgP_grads, update_lgP_grads_approx
...
contains
    ...
    subroutine noise_likelihood(dat,RTI,like)
        implicit none
    ...
    subroutine update_lgP_grads(dat,RTI,settings,like)
        implicit none
        type(T_DATA), intent(in)                    :: dat
    ...
    subroutine likelihood(dat,RTI,settings,like)
