...
%%
for i = chains
    sources_ = dlmread(['../Results/resume/run_time_sources_' num2str(i) '.dat']);
    sources(:,1:3) = sources_(2:2:end,1:3); sources(:,4) = sources_(3:2:end,1);
    figure;
    plot(sources(:,4),src_true(:,4),'b*');
    axis equal; %axis([-0.01 0.01 -0.01 0.01]);
